cd
dotnet publish -c Release -r win-x86 -p:PublishSingleFile=true  -p:PublishReadyToRun=true --self-contained true
...
dotnet publish -c Release -r linux-arm64 -p:PublishSingleFile=true -p:PublishReadyToRun=true --self-contained true
