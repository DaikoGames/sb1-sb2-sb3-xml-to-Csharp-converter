cd
cd .\bin\Release\net9.0\win-x64
vpk pack --packId ScratchSnapToCsharpConverter --packVersion 1.0.0 --packDir .\publish --mainExe Converter.exe --icon C:\Users\david\Converter\Converter\ConverterIcon\Converter.ico
cd /d "%~dp0"
cd .\bin\Release\net9.0\win-x86
